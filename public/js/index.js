        ...
        if(captcharesponse){
            $.ajax({
                ...
                if(response._id){
                    ...
                    var html = '<div id="newmodal" class="text-center"> <i style="font-size: 75px;" class="fab fa-plane color-primary"></i>\n' +
                        '            <h3>\n' +
        ...
        if(name==""){
            ...
            $.ajax({
                ...
                if(response!==false){
                    console.log(response);
                    emailInput.addClass("is-invalid");
                    emailHelp.html(`You already have account with this email. <a class="loginthroughthis" href="#">Log in</a> through this email.`).removeClass("d-none");
                }
                else{
