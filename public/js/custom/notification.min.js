$(function () {
  $(".notificationlink").on("click", function (i) {
    i.preventDefault();
    var n = $(this);
    $(".notification-box")
      .addClass("d-none")
    ...
    $.ajax({
      ...
      data: {
        email: t,
        notifications: JSON.stringify(o),
        title: a,
        description: s,
      },
    }).done(function () {
      $(".notificationspinner").addClass("d-none"),
        ...
        n.closest(".notification-box").remove(),
        setTimeout(function () {
          window.location.href = "/dashboard";
        }, 2e3);
    });
  }),
    $("body").on("click", ".dropdown-menu", function (i) {
      $(this).parent().hasClass("show") && i.stopPropagation();
    });
});
