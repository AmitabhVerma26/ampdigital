$(function () {
    $(".notificationlink").on("click", function(e){
        e.preventDefault();
        var el = $(this);
        $(".notification-box").addClass("d-none").last().after("<i class='notificationspinner fa fa-spinner fa-spin'></i>");
        ...
        $.ajax({
            ...
            data: {email: email, notifications: JSON.stringify(notifications), title: title, description: description}
        }).done(function() {
