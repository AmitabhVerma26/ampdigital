$(document).ready(function () {
  var e = $("#firstsection").data("sectionwidth");
  function o(e) {
    for (
      var o = e + "=",
      ...
      for (var t = a[n]; " " == t.charAt(0); ) t = t.substring(1);
      if (0 == t.indexOf(o)) return t.substring(o.length, t.length);
    }
    return "";
  }
  if (o("referralcode")) {
    var a = o("referralcode");
    $(".couponcode2, .couponcode3").val(a).prop("readonly", !0),
      $.ajax({
        type: "GET",
        url: "/isvalidcoupon?couponcode=" + a,
        success: function (o) {
          var n = e;
          !1 !== o
            ? (!1 !== o
                ? ("referralcode" == o.type
                    ? ((n = n / 1.18 - (0.2 * n) / 1.18), (n += 0.18 * n))
                    : "amount" == o.type
                      ? (n -= o.discount)
                      : (n -= (n * o.discount) / 100),
                  $(".courseprice, .courseprice3").html(n),
              ...
              $(".courseprice, .courseprice3").html(n),
              $(".discountmessage").html(
                `<span style="color:green; font-size: small">Referral Code ${a} applied</span>`,
              ))
            : ($(".courseprice, .courseprice3").html(e),
              $(".discountmessage").html(
                `<span style="color:red; font-size: small">Referral Code ${a} invalid</span>`,
              ));
        },
      });
  }
  ...
  n.prototype = {
    constructor: n,
    isElementInView: function (e, o) {
      var a = $(window).scrollTop(),
        n = a + $(window).height(),
        t = $(e).offset().top,
        l = t + $(e).height();
      return !0 === o ? a < t && n > l : t <= n && l >= a;
    },
  };
  var n = new n();
  $(".image-container").on("click", function () {
    ...
    $(".nav-link-scroll").click(function (e) {
      ...
      $("html, body").animate({ scrollTop: $("#" + o).offset().top }, 500);
    });
  var t,
    l = "";
  ...
  function r() {
    for (
      ...
      (e = a[n].split("=")), o.push(e[0]), (o[e[0]] = e[1]);
    return o;
  }
  if (
    (i.on("keyup", function () {
      clearTimeout(t), (t = setTimeout(s, 1e3));
    }),
    ...
    void 0 !== r().payment && "true" == r().payment)
  ) {
    l = r().batchdate;
    var c = e,
      d = 0,
      ...
      p = 0,
      m = "",
      f = $(".enrollnow").data("paymentemail"),
      v = $(".enrollnow").data("paymentname"),
      g = $(".enrollnow").data("paymentphone"),
      w = $(".enrollnow").data("paymentcouponcode");
    if (
      (void 0 !== r().couponcode &&
        "" !== r().couponcode &&
        (w = r().couponcode),
      ...
      return;
    var h = $(".enrollnow").data("paymentuser_id");
    $(".course-details").before(
      ...
      $.ajax({
        type: "GET",
        url: "/isvalidcoupon?couponcode=" + w,
        success: function (e) {
          !1 !== e &&
            ("referralcode" == e.type
              ? ((u = e.type),
                (d = (c * e.offertoenrollment) / 100),
                (p = e.offertoparticipant),
                (m = e.participantname),
                (c = c / 1.18 - (0.2 * c) / 1.18),
                (c += 0.18 * c))
              : "amount" == e.type
                ? ((d = e.discount), (c -= d))
                : ((d = (c * e.discount) / 100), (c -= d)),
            (couponcodeexists = !0));
          var o = h + "_5efdc00ef1f2a30014a1fbef";
          if ("true" !== r().enrolled && "" !== f) {
            const e = {
              ...
              email: f,
              coupontype: u,
              couponcodeapplied: 1 == couponcodeexists ? "yes" : "no",
              couponcode: 1 == couponcodeexists ? w : "",
              discount: d,
              offertoparticipant: p,
              participant: m,
              phone: g,
              user_id: o,
              redirect_url: `${window.location.origin}/callback?user_id=${o}&batchdate=${l}`,
              webhook_url: "/webhook/",
            };
            $.ajax({
              type: "POST",
    ...
    $(".enrollnow").on("click", function (e) {
      ...
      var o = $(".emailvalue").val(),
        ...
        t =
          ...
          $(".related-courses"),
          $("#paymentform"));
      "loggedin" == $(this).data("formtype") &&
        (void 0 === (l = $(".batchdatevalueloggedin").val()) ||
        "" == l ||
        null == l
          ...
          : "" !== $(".couponcode3").val()
            ...
            : (window.location.href =
                ...
                l +
                "&payment=true")),
        "login" == $(this).data("formtype")
          ? void 0 === (l = $(".batchdatevalue").val()) || "" == l || null == l
            ? $.alert("Kindly fill batchdate")
            : $.ajax({
                type: "GET",
                url:
                ...
                success: function (e) {
                  3 != e
                    ? 2 == e &&
                      ...
                      $("#couponcodelogin").val(n.val()),
                      $("#paymentform2").submit())
                    : $.alert("Invalid Password");
                },
              })
          : "signup" == $(this).data("formtype")
            ? void 0 === (l = $(".batchdatevaluesignupform").val()) ||
              "" == l ||
              null == l
              ? $.alert("Kindly fill batchdate")
              : $.ajax({
                      ...
                      : 2 == e
                        ...
                        : 1 == e
                          ...
                          : 3 == e &&
                            ...
                            $(
                              ".paymentsignupform, .paymentloginform",
                            ).toggleClass("d-none"),
