$(document).ready(function () {
  ...
  $(".alreadyaccount").on("click", function (o) {
    o.preventDefault(),
      $("#loginModal").modal("toggle"),
      $("#createAccount").modal("toggle");
  }),
    $(".course").on("click", function (o) {
      o.preventDefault(), (window.location.href = $(this).data("href"));
    }),
    ("true" != $("body").data("success") && 1 != $("body").data("success")) ||
      (window.history.pushState("Details", "Title", "/"),
      $.alert("We have received your query. We will get back to you soon.")),
    $("#tocert").on("click", function (o) {
      o.preventDefault(),
        $("html, body").animate(
    ...
    $("#enquirenow, #enquirenow2, #enqirenow3").on("click", function (o) {
      o.preventDefault(),
        $("html, body").animate({ scrollTop: $("#courses").offset().top }, 500);
    }),
    $("#viewcourses").on("click", function (o) {
      o.preventDefault(),
        $("html, body").animate({ scrollTop: $("#courses").offset().top }, 500);
    }),
    $(".forgotpasswordbutton").on("click", function (o) {
      o.preventDefault(),
        $(".loginform").addClass("d-none"),
        $(".forgotpasswordform").removeClass("d-none"),
        $(".loginpaneltitle").html("Forgot Password");
    }),
    $(".loginformbutton").on("click", function (o) {
      o.preventDefault(),
        $(".loginform").removeClass("d-none"),
        $(".forgotpasswordform").addClass("d-none"),
        $(".loginpaneltitle").html("Login");
    }),
    $(".forgotpasswordform").on("submit", function (o) {
