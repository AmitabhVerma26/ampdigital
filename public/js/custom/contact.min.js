function checkform(a) {
  var t = "";
  if (
    ("" == a.CaptchaInput.value && (t += "- Please Enter CAPTCHA Code.\n"),
    "" != a.CaptchaInput.value &&
      0 == ValidCaptcha(a.CaptchaInput.value) &&
      (t += "- The CAPTCHA Code Does Not Match.\n"),
    "" != t)
  )
    return alert(t), !1;
}
$(".forgotpasswordbutton").on("click", function (a) {
  a.preventDefault(),
    $(".loginform").addClass("d-none"),
    $(".forgotpasswordform").removeClass("d-none"),
    $(".loginpaneltitle").html("Forgot Password");
}),
  $(".alreadyaccount").on("click", function (a) {
    a.preventDefault(),
  ...
  $(".forgotpasswordform").on("submit", function (a) {
    $(this).children("button").attr("disabled", "disabled"), a.preventDefault();
    var t = $("#forgotpasswordemail").val();
    $.ajax({
      method: "POST",
...
function ValidCaptcha() {
  return (
    ...
    removeSpaces(document.getElementById("CaptchaInput").value)
  );
}
