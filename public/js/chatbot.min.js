  ...
  $(".alreadyaccount")
    ...
    $(".registernow").on("click", function (s) {
      ...
      var a = $(this).closest(".registerform"),
        ...
        b = a.find(".repassword");
      i.addClass("d-none"),
        d.removeClass("is-valid").removeClass("is-invalid"),
        c.addClass("d-none"),
        m.removeClass("is-valid").removeClass("is-invalid"),
        u.addClass("d-none"),
        v.removeClass("is-valid").removeClass("is-invalid"),
        o.addClass("d-none"),
        t.removeClass("is-valid").removeClass("is-invalid"),
        f.addClass("d-none"),
        g.removeClass("is-valid").removeClass("is-invalid"),
        w.addClass("d-none"),
        b.removeClass("is-valid").removeClass("is-invalid"),
        "" == l
          ? (d.addClass("is-invalid"),
            i.html("Please enter name").removeClass("d-none"))
          : "" == r
            ? (m.addClass("is-invalid"),
              c.html("Please enter last name").removeClass("d-none"))
            : "" == n
              ? (t.addClass("is-invalid"),
                o.html("Please enter email").removeClass("d-none"))
              : e(n)
                ? "" == h
                  ? $.ajax({
                      method: "GET",
                      ...
                      !1 !== e
                        ...
                        : (v.addClass("is-invalid"),
                          u.html("Please enter phone").removeClass("d-none")),
                  ...
                  : "" == p
                    ? (g.addClass("is-invalid"),
                      f.html("Please enter password").removeClass("d-none"))
                    : "" == C
                      ? (b.addClass("is-invalid"),
                        w
                          .html("Please enter password again")
                          .removeClass("d-none"))
                      : C !== p
                        ? (b.addClass("is-invalid"),
                          w
                ...
                : (t.addClass("is-invalid"),
                  o.html("Please enter valid email").removeClass("d-none"));
    }),
      ...
      o.addClass("d-none"),
        ...
        "" == n
          ...
          : e(n)
            ? "" == t
              ? (d.addClass("is-invalid"),
                l.html("Please enter password").removeClass("d-none"))
              : a.submit()
            : (i.addClass("is-invalid"),
              o.html("Please enter valid email").removeClass("d-none"));
    }),
      ...
      e.preventDefault(),
        1 == s &&
          (setTimeout(function () {
            ...
            (s.className = "lexResponse"),
              s.appendChild(document.createTextNode("Hi")),
              $(s).append('<img src="/kendra.svg" style="width: 2rem;">'),
...
function pushChat2() {
  ...
  return (
    showRequest("Yes"),
    lexruntime.postText(e, function (e, s) {
      e &&
        (console.log(e, e.stack),
        showError("Error:  " + e.message + " (see console for details)")),
        s && ((sessionAttributes = s.sessionAttributes), showResponse(s));
    }),
    !1
  );
}
...
function pushChat() {
  ...
  if (e && e.value && e.value.trim().length > 0) {
    ...
    showRequest(s),
      lexruntime.postText(a, function (s, a) {
        s &&
          (console.log(s, s.stack),
          showError("Error:  " + s.message + " (see console for details)")),
          a &&
            (console.log("jere"),
            console.log(a),
            a.slots.Question &&
            ...
            (sessionAttributes = a.sessionAttributes),
            showResponse(a)),
          (e.value = ""),
          (e.locked = !1);
      });
...
function showResponse(e) {
  var s = document.getElementById("conversation"),
    a = document.createElement("P");
  (a.className = "lexResponse"),
    e.message &&
      (a.appendChild(document.createTextNode(e.message)),
      $(a).append('<img src="/kendra.svg" style="width: 2rem;">'),
