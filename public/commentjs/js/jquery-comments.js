    ...
    var Comments = {
        ...
        getDefaultOptions: function() {
            return {
                ...
                textareaPlaceholderText: 'Post a Question or Start a discussion',
                newestText: 'Newest',
                oldestText: 'Oldest',
                popularText: 'Popular',
                ...
                noCommentsText: 'No discussions. Be the first to start!',
        ...
        postComment: function(ev) {
            if($("body").data("fullname")==""){
                ...
                $(".modal-title").html("Login to ask or participate in discussions")
            }
            else{
                var self = this;
        ...
        this.$el.html(html).contents();
        $(".modal_body").html(mainCommentingField)
        //    this.$el.append(html);
        ...
        createProfilePictureElement: function(src, userId, fullname, time) {
            if(src) {
                if(fullname){
                    if(src=="https://viima-app.s3.amazonaws.com/media/public/defaults/user-icon.png"){
                    src="https://ui-avatars.com/api/?name="+fullname+"&rounded=true";
                }   
                }
              var profilePicture = $('<div/>');
              profilePicture.html(`<img style="width:3rem;" src="${src}">`)
              if(fullname){
                profilePicture.append(`<span style="font-size:.8rem; line-height:14px; width: 12rem!important;"><a class="profilelink ml-1" href="#">${fullname}</a> <span style="color: #636567">(${time})</span></span>
                                        <br>`)
              }
            } else {
            ...
            profilePicture.addClass('row align-items-center ml-0');
        ...
        createNavigationElement: function() {
            ...
            var attachments = $('<li/>', {
                text: 'Write Post',
                'data-sort-key': 'attachments2',
                'class': 'btn btn-primary writepost d-none'
            });
        ...
        createCommentWrapperElement: function(commentModel) {
            ...
            var commentWrapper = $('<div/>', {
             ...
             // Time
             var time =  this.options.timeFormatter(commentModel.created)

            // Profile picture
            var profilePicture = this.createProfilePictureElement(commentModel.profilePictureURL, commentModel.creator, commentModel.fullname, time);
            ...
            if(this.options.enableAttachments && commentModel.attachment_url) {
                var filesArray = [ 
                    {
                        "id" : commentModel.attachment_id,
                        "file" : commentModel.attachment_url,
                        "mime_type" : commentModel.attachment_type
                    }
                ]
                $(filesArray).each(function(index, attachment) {
